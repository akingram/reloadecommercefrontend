...
const PaymentVerification = () => {
  ...
  useEffect(() => {
    const verify = async () => {
      ...
      console.log("Payment verification params:", { transaction_id, orderId });
      ...
      try {
        const response = await verifyPayment(transaction_id, orderId);
      ...
      <div className="bg-white p-8 rounded-lg shadow-md text-center max-w-md w-full mx-4">
        ...
        {status === "success" && (
          <>
            ...
            <h2 className="text-2xl font-semibold mb-4">Payment Successful!</h2>
            <p className="text-gray-600 mb-6">
              Your cart has been cleared and we're redirecting you to order
              confirmation...
            </p>
            {order && (
              <div className="bg-gray-50 p-4 rounded-md text-left">
